    ...
    ReentrancyGuard
{
    ...
    function directAssetTransfer(
        ...
        if (msg.sender != address(this) || !configuration.canPerformDirectTransfer()) revert UnauthorizedCall();
    ...
    function decodeAndCall( 
        ...
        (address srcToken, address desToken, , ,) = IAspisDecoder(_decoder).decodeExchangeInput(_ethValue, _data);        
